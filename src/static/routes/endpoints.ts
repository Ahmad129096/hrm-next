export const endPoints = {
  ...
  LOGOUT: "/auth/logout",
  EMAIL_VERIFY: "api/email-verification",
  ORGANIZATION_CATEGORIES: "api/organizationcategories",
  OTP_VERIFY: "api/otpVerification",
  FORGET_PASSWORD: "api/Verifyemailforgotpassword",
  FORGET_VERIFY: "api/forgotpassword",
  ORGANIZATION_LOGO: "api/uploadimage",
  ...
  CREATE_JOB: "api/Create-jobsControllers",
  GET_DEPARTMENT: "api/department",
  VIEWJOB: "api/View-jobsControllers",
